  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[#050F0C] select-none touch-none">
      <img
        ...
        aria-hidden="true"
      />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(5,15,12,.22),rgba(5,15,12,.9))]" />
      <div
        ...
        <AnimatePresence>
          ...
          >
            ...
            <motion.div
              ...
              animate={
                isCardRising ? { y: -250, scale: 2.8, zIndex: 60 } : { y: 0, scale: 1, zIndex: 20 }
              }
              transition={{ duration: 1.5, ease: "easeInOut" }}
            >
              {/* Card Content */}
              <div className="text-center opacity-90 p-4 border border-[#C9A96E]/30 m-2 flex flex-col items-center justify-center w-[calc(100%-16px)] h-[calc(100%-16px)] bg-white/20">
                <span className="font-cinzel text-[8px] tracking-[0.3em] text-[#C9A96E] uppercase mb-2">
                  Davetiye
                </span>
                <h2 className="font-playfair text-xl text-[#0A1F18] leading-tight">
                  {partnerOne} <br />
                  <span className="text-sm italic">&</span>
                  <br /> {partnerTwo}
                </h2>
                <span className="font-sans text-[9px] text-[#0A1F18]/60 mt-3 tracking-widest">
                  {date}
                </span>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              style={{
                ...
                backgroundImage:
                  "linear-gradient(to bottom, rgba(255,255,255,0.05), rgba(0,0,0,0.15))",
              }}
            ...
            <motion.div
              ...
              animate={
                isOpen ? { scale: 1.2, opacity: 0 } : { scale: 1, opacity: 1, y: "-50%", x: "-50%" }
              }
              transition={{ duration: 0.4 }}
              onClick={handleOpen}
            >
              <div
                className="w-[50px] h-[50px] rounded-full border border-red-900 flex items-center justify-center opacity-80"
