    ...
    <div className="relative min-h-[100dvh] overflow-x-hidden bg-background text-foreground antialiased font-sans flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-24 md:py-32 max-w-4xl">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none text-muted-foreground">
          ...
          <p>
            Barış Savrun (MemoryWedding) olarak kişisel verilerinizin güvenliğine en üst düzeyde önem veriyoruz. 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK) uyarınca, ürün ve hizmetlerimizi kullanırken bizimle paylaştığınız kişisel verilerinizin nasıl işlendiği, saklandığı ve korunduğu aşağıda açıklanmıştır.
          </p>

          <h3 className="text-xl font-semibold text-foreground mt-8 mb-4">1. Hangi Verileri Topluyoruz?</h3>
          <p>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>Etkinlik Bilgileri: Düğün tarihi, mekanı, çift isimleri ve etkinlikle ilgili panele girdiğiniz detaylar.</li>
              <li>Misafir Verileri: Sisteme davetli olarak LCV (RSVP) bırakan veya fotoğraf yükleyen misafirlerinizin ad-soyad bilgileri ve yüklenen dijital içerikler.</li>
              <li>Ödeme Verileri: Ödeme işlemleriniz yetkili ödeme kuruluşları (örn. PayTR) aracılığıyla gerçekleştiğinden, kredi kartı numarası gibi hassas finansal verileriniz tarafımızca saklanmaz.</li>
            </ul>
          </p>

          <h3 className="text-xl font-semibold text-foreground mt-8 mb-4">2. Verileri Hangi Amaçla İşliyoruz?</h3>
          <p>
            Kişisel verilerinizi şu amaçlarla işliyoruz:
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>Dijital davetiye ve etkileşim (QR Galeri vb.) hizmetlerinin sağlanması ve sürdürülmesi,</li>
