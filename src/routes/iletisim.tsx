...
export const Route = createFileRoute("/iletisim")({
  head: () =>
    pageSeo({
      title: "İletişim ve Destek | MemoryWedding",
      description:
        "Dijital davetiye, LCV ve QR fotoğraf galerisi hakkında MemoryWedding destek ekibine e-posta, telefon veya WhatsApp ile ulaşın.",
      path: "/iletisim",
    }),
      ...
      <main className="flex-1 container mx-auto px-4 py-24 md:py-32 max-w-4xl">
        ...
        <div className="max-w-none">
          <p className="text-lg text-muted-foreground mb-8">
            MemoryWedding hizmetleri ile ilgili her türlü soru, öneri ve talebiniz için bizimle
            ...
            <div className="bg-surface p-8 rounded-2xl border border-border">
              ...
              <ul className="space-y-4">
                <li>
                  ...
                  <a href="mailto:brsvrn@gmail.com" className="text-primary hover:underline">
                    brsvrn@gmail.com
                  </a>
                </li>
                <li>
                  ...
                  <a href="tel:05303811155" className="text-primary hover:underline">
                    0530 381 1155
                  </a>
                </li>
                <li>
